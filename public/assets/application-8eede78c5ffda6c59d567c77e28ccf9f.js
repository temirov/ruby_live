...
(function() {
  var listenToLiveStream;

  listenToLiveStream = function() {
    var source;
    source = new EventSource('/events');
    return source.addEventListener('Refresh', function(e) {
      return $.getScript("/dashboard.js");
    });
  };

  $(function() {
    return listenToLiveStream();
  });
